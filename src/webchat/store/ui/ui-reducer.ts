...
export const setUILanguage = (uiLanguage: string) => ({
    type: SET_UI_LANGUAGE as 'SET_UI_LANGUAGE',
    uiLanguage
});

export type SetUILanguageAction = ReturnType<typeof setUILanguage>;
...
type UIAction = SetUILanguageAction
    | SetOpenAction 
    | SetTypingAction 
    | SetInputModeAction 
