...
class RatingDialog extends React.PureComponent<React.HTMLProps<HTMLDivElement> & IRatingDialogProps, IRatingDialogState> {
    ...
    render() {
        ...
        return (
            <Wrapper>
                <RatingDialogRoot  className="RatingDialog" role="dialog" aria-modal="true" aria-labelledby={webchatRatingDialogTitleId} onKeyDown={this.handleKeydown}>
                    <RatingDialogHeader className="ratingHeader">
                    ...
                    <RatingDialogMain>
                        ...
                        <div>
                            <div id={webchatRatingCommentLabelId}>Please select thumbsup/ thumbsdown and submit. (Comment optional)</div>
                        </div>
                    </RatingDialogMain>
                    <RatingToolbar>
                        <RatingInput
                            type="text"
                            value={ratingText}
                            //value="Comment functionality will be available in next release."
                            onChange={this.handleSetRatingText}
                            //style={{ color: "#9FAFB8" }}
                            //autoFocus                         //uncomment this line to autofocus on textarea directly
                            maxlength={500}
                            rows={3}
